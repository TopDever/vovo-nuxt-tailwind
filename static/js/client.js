...
var Botkit = {
    config: {
        ...
        */
        ws_url: 'wss://chatclient.vovo.chat',
    ...
    connectWebsocket: function (ws_url) {
        ...
        that.socket.addEventListener('open', function (event) {
            ...
            that.deliverMessage({
                ...
                preview_mode: that.preview_mode,
                channel: 'socket',
    ...
    receiveCommand: function (event) {
        switch (event.data.name) {
            ...
            case 'connect':
                ...
                break;
            case 'autogreet':
                Botkit.customEvent('autogreet');
                console.log('AUTOGREET');
                break;
            default:
    ...
    var event = new CustomEvent('autogreet', {});
    this.message_window.dispatchEvent(event);
    ...
    */
    ...
    boot: function (user) {
        ...
        that.message_list.append(that.replies);
        ...
        that.on('message', function (message) {
            ...
            that.renderMessage(message);
            var messageBody = document.querySelector('#message_list');
...
(function () {
    ...
    Botkit.auth_token  = urlParams.get('auth_token');
    if ( urlParams.has("preview") ) {
        Botkit.preview_mode = true;
    }
    console.log("preview_mode:" + Botkit.preview_mode);
    Botkit.boot();
})();